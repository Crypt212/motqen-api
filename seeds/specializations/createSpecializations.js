...
/**
 * Seed the database with predefined specializations and their sub-specializations.
 *
 * Creates missing specialization records from the local `specializations` array, creates associated sub-specializations linked to each created specialization, skips records that already exist, logs progress, and ensures the Prisma client is disconnected when finished.
 *
 * @throws {Error} Re-throws any error encountered during the seeding process.
 */
async function main() {
