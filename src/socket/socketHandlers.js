...
/**
 * Return the partner's userId for a two-party conversation.
 * @param {import('@prisma/client').Conversation & { participants: import('@prisma/client').ConversationParticipant[] }} conv - Conversation record including its participants.
 * @param {string} myUserId - The current user's userId used to identify the other participant.
 * @returns {string | undefined} The partner's userId, or `undefined` if no other participant is found.
 */
